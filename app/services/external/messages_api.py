...
class MessagesApi(BaseClient):
    ...
    async def log_incoming_message(
        ...
        try:
            ...
            response = await self._make_request("POST", "api/v1/message-history/log/incoming", json=payload)
    ...
    async def log_outgoing_message(
        ...
        try:
            ...
            response = await self._make_request("POST", "api/v1/message-history/log/outgoing", json=payload)
